<template>
  ...
  <div
    ...
    class="fixed shadow-md bg-white z-50 h-screen flex justify-start flex-col items-center top-0 px-2 overflow-auto"
  >
  ...
  <div
    class="w-full z-40 h-screen fixed top-0 left-0"
    @click="show_menu = !show_menu"
    :style="{
      display: show_menu ? 'none' : 'block',
